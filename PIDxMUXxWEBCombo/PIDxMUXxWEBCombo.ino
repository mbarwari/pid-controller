...
//PWM Frequency Generator Variables
  ...
  PinName pin = digitalPinToPinName(D11);
...
void setup() {
  ...
  //Setting up I2C Devices
    Serial.println("I2C setup: "); 
      ...
      Wire1.begin();
      //flowSensorB.begin(Wire, SLF3S_4000B_I2C_ADDR_08);
      delay(100);
...
{    
  tm t;
            ...
            t.tm_year = ((24)+100+1900);   // year since 1900,  current year + 100 + 1900 = correct year
